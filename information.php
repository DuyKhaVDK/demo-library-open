            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="shopping-item">
                        <a href="cart.php">Giỏ Hàng<span  class="cart-amunt" id="TongTien"></span> <i class="fa fa-shopping-cart"></i> <span  class="product-count" id="soLuong">1</span></a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row">
      ...
      <div class="text-center">
        <img src="imgUser/<?php echo $arrUser[8]; ?>" class="avatar img-circle img-thumbnail" alt="avatar">
          ...
          <ul class="list-group">
            <li class="list-group-item text-muted">Thông tin cá nhân <i class="fa fa-dashboard fa-1x"></i></li>
            <li class="list-group-item text-right"><span class="pull-left"><strong>Mã của bạn</strong></span> <?php echo $arrUser[0]; ?></li>
            <li class="list-group-item text-right"><span class="pull-left"><strong>Họ và tên</strong></span> <?php echo $arrUser[1]; ?></li>
            <li class="list-group-item text-right"><span class="pull-left"><strong>Ngày sinh</strong></span> <?php echo $arrUser[2]; ?></li>
            <li class="list-group-item text-right"><span class="pull-left"><strong>Số điện thoại</strong></span> <?php echo $arrUser[4]; ?></li>
          </ul> 
            ...
            <div class="row">
                <div class="col-md-3 col-sm-6">
                    <div class="footer-about-us">
                        ...
                        <p>Nơi dây có sách hay cho bạn !!!</p>
