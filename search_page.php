  ...
  <head>
   ...
   <body onload="showCart();Cart();total_Cart()">
            ...
            <div class="row">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active"><a href="search_page.php?page=1">TÌM KIẾM SẢN PHẨN</a></li>
    ...
    < <!-- End Page title area -->
            ...
            <div >
                <input style="margin: 8px 35%; width:30%;" class="form-control"  type="text" placeholder="Tìm kiếm..." id="inputSearch">
            </div>
