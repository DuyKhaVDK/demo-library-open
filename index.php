            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="shopping-item">
                        <a href="cart.php">Giỏ Hàng<span id="TongTien" class="cart-amunt"></span> <i class="fa fa-shopping-cart"></i> <span id="soLuong" class="product-count">1</span></a>
                    </div>
                </div>
            </div>
        </div>
